	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(compte_crediteur!=null && compte_debiteur!=null)
		{
			...
			}else
			{
				...
				String erreur ="Virement impossible ! Pas assez de crédit !";
				...
				String erreur ="Virement impossible ! le compte créditeur n'est pas a vous !";
				req.setAttribute("error", erreur);
				req.getRequestDispatcher("/WEB-INF/index.jsp").forward(req, resp);
		...
		}else
		{
			...
			String erreur ="Virement impossible ! Compte inexistant !";
			req.setAttribute("error", erreur);
			req.getRequestDispatcher("/WEB-INF/index.jsp").forward(req, resp);
		}
	}
