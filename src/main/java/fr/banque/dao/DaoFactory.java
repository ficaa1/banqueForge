...
public class DaoFactory {
	...
	//Identifiants de connexion a la bdd Mysql "jdbc:mysql://localhost:3306/banque"
    ...
    public static DaoFactory getInstance() {
    	...
    	//ICI ON MODIFIE L ID et MDP D'ACCES A LA BDD Mysql
        DaoFactory instance = new DaoFactory(
                "jdbc:mysql://localhost:3306/banque", ID, MDP);
        return instance;
    }
